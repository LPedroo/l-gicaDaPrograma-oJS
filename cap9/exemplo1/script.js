function adicionarTarefa() {
  ...
  var h5 = document.createElement("h5"); //Cria h5
  var texto = document.createTextNode(tarefa); // Cria um texto
  h5.appendChild(texto); //Define que o texto vai ser filho do h5
  divQuadro.appendChild(h5); //... h5 será filho de divQuadro
...
function recuperarTarefasSalvas() {
  ...
  if (localStorage.getItem("tarefasDia")) {
    // cria um vetor com a lista de tarefas (separadas pelos plit(";"))
